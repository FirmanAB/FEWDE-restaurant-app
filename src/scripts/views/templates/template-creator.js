...
const createRestaurantDetailTemplate = (restaurant) => `
  ...
  <div class="restaurant__info">
    ...
    <h4>Food Categories : ${restaurant.categories.map((category) => category.name)}</h4>
  </div>
    ...
    <h4>Customer Review</h4>
        ${restaurant.customerReviews.map((review) => `
            <div class="restaurantInfoList">
                ...
                <p tabindex="0" class="review-content">${review.review}</p>
            </div>
        `).join('')}
  </div>
...
const createRestaurantItemTemplate = (restaurant) => `
    <div class="restaurant-item" >
        ...
        <div class="restaurant-item__content">
            <h3 class="restaurant__title"><a href="${`/#/detail/${restaurant.id}`}" class="restaurant-item_link">${restaurant.name || '-'}</a></h3>
            <p>${restaurant.description}</p>
        </div>
    </div>
`;
